...
class XBot:
    def __init__(self, theme):
        ...
        generate_post = GeneratePost(business_theme=business_theme, temporal_theme=temporal_theme)
    ...
    def connection_process(self):
        ...
        # connect_final = driver.find_element(By.XPATH, '//*[@id="layers"]/div[2]/div/div/div/div/div/div[2]/div[2]'
