...
class GeneratePost:
    def __init__(self, business_theme, temporal_theme):
        ...
        self.ai_prompt = ""
        self.business_theme = business_theme
    ...
    def generate_prompt(self):
        ...
        will be holding is a good social media content manager for {self.business_theme} who creates the most suitable 
        post to the context above. 
